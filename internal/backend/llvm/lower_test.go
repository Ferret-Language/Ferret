...
func TestLowerProgramDebugDeclsFallbackToFunctionFileForNilVarLocation(t *testing.T) {
	loc := source.NewLocation("/tmp/ferret-debug-decls.fer", source.Position{Line: 1, Column: 1}, source.Position{Line: 1, Column: 1})
	voidType := &typeinfo.BuiltinType{Name: "void"}
	i32Type := &typeinfo.BuiltinType{Name: "i32"}
	mod := &mir.Module{
		Key:        "main",
		ImportPath: "main",
		FilePath:   "/tmp/ferret-debug-decls.fer",
		Functions: []*mir.Function{
			{
				Name:   "with_debug_decls",
				Result: voidType,
				Params: []*mir.Param{
					{Name: "p", LocalID: 1, Type: i32Type, Location: source.Location{}},
				},
				Locals: []*mir.Local{
					{ID: 1, Name: "p", Type: i32Type, Mutable: true, Location: source.Location{}},
					{ID: 2, Name: "x", Type: i32Type, Mutable: true, Location: source.Location{}},
				},
				EntryID:  0,
				Blocks:   []*mir.Block{{ID: 0, Terminator: &mir.ReturnTerm{}}},
				Location: loc,
	...
	for _, want := range []string{
		"call void @llvm.dbg.declare(metadata ptr %p_alloca",
		"call void @llvm.dbg.declare(metadata ptr %x_alloca",
	} {
