...
// LoadEmbedded loads stdlib from the embedded filesystem into the compiler context.
// This makes global.fer and std/* available for compilation.
func LoadEmbedded(ctx *context_v2.CompilerContext) {
	if ctx == nil {
		return
	}
